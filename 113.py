...
tab_control.add(tab3, text='Добавление сотрудников')
tab2 = ttk.Frame(tab_control)
tab_control.add(tab2, text='Контрагенты')
tab4 = ttk.Frame(tab_control)
tab_control.add(tab4, text='Добавление сотрудников')
companies = [
...
def serch1():
    ...
    for row1 in sotr:
        if fio_entry1.get() == row1[1] or int(inn_entry1.get()) == row1[5]:
...
def add1():
    ...
    for row1 in sotr:
        table1.insert('', tkinter.END, values=row1)
# таблица
heads1 = ["№", "Фамилия", "Имя", "Отчество", "Снилс сотрудника", "ИНН сотрудника", "Контрагент"]
...
scr_p1.grid(row=2, column=7, sticky='ns')
...
f_label3 = tkinter.Label(tab3, text="Фамилия")
f_label3.grid(row=0, column=0)
f_entry3 = tkinter.Entry(tab3)
f_entry3.grid(row=1, column=0)

i_label3 = tkinter.Label(tab3, text="Имя")
i_label3.grid(row=0, column=1)
i_entry3 = tkinter.Entry(tab3)
i_entry3.grid(row=1, column=1)

o_label3 = tkinter.Label(tab3, text="Отчество")
o_label3.grid(row=0, column=2)
o_entry3 = tkinter.Entry(tab3)
o_entry3.grid(row=1, column=2)

cn_label3 = tkinter.Label(tab3, text="Снилс Сотрудника")
cn_label3.grid(row=0, column=3)
cn_entry3 = tkinter.Entry(tab3)
cn_entry3.grid(row=1, column=3)

inn_label3 = tkinter.Label(tab3, text="ИНН сотрудника")
inn_label3.grid(row=0, column=4)
inn_entry3 = tkinter.Entry(tab3)
inn_entry3.grid(row=1, column=4)

con_label3 = tkinter.Label(tab3, text="Контрагент")
con_label3.grid(row=0, column=5)
con_entry3 = tkinter.Entry(tab3)
con_entry3.grid(row=1, column=5)

add_button3 = tkinter.Button(tab3, text="Добавить", command=add1)
add_button3.grid(row=0, column=6, sticky="news", padx=0)
...
table1.grid(row=2, column=0, columnspan=7)
